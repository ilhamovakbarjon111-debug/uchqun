...
// CRUD operations (teachers, admins, and reception)
router.post('/', requireRole('teacher', 'admin', 'reception'), createActivityValidator, handleValidationErrors, createActivity);
router.put('/:id', requireRole('teacher', 'admin', 'reception'), activityIdValidator.concat(updateActivityValidator), handleValidationErrors, updateActivity);
router.delete('/:id', requireRole('teacher', 'admin', 'reception'), activityIdValidator, handleValidationErrors, deleteActivity);
