...
export function TeacherRatingScreen() {
  ...
  const header = (
    <View style={styles.topBar}>
      ...
      <Text style={styles.topBarTitle} allowFontScaling={true}>Rate Teacher</Text>
        ...
        {loading ? (
          ...
          <Card style={styles.card}>
            <View style={styles.iconContainer}>
              <Ionicons name="school" size={48} color={tokens.colors.semantic.warning} />
            </View>
            <Text style={styles.title} allowFontScaling={true}>Rate Your Teacher</Text>
